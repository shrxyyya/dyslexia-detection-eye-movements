...
# Load original data
fixations = pd.read_csv('real-data/Subject_1350_T4_Meaningful_Text_fixations.csv')

# Load corrected synthetic data for comparison
synthetic_data_corrected = pd.read_csv("synthetic-data/Subject_2350_T4_Meaningful_Text_fixations.csv")
